...
class ShopPanel(UIPanel):
    ...
    def __init__(self, game: "App"):
        ...
        self.set_label("SHOP")
        self.set_animation( (self.st.SCREEN_WIDTH - 280, mid_pos), (self.st.SCREEN_WIDTH, mid_pos), 1000 )
        ...
        for row, build in enumerate(self.building):
            ...
            element = UICompose(30, 120 + (row * 230), 200, 200, build, sprite, action, f"{str(cost)} $", f"{child_uid}_{row}" )
